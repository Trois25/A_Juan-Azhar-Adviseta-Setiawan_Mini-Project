...
// EventsDataInterface is an autogenerated mock type for the EventsDataInterface type
type EventsDataInterface struct {
	mock.Mock
}

// DeleteEvent provides a mock function with given fields: id
func (_m *EventsDataInterface) DeleteEvent(id string) error {
	ret := _m.Called(id)
...
func (_m *EventsDataInterface) PostEvent(data events.EventsCore, image *multipart.FileHeader) (int, error) {
...
func (_m *EventsDataInterface) ReadAllEvent() ([]events.EventsCore, error) {
	ret := _m.Called()
...
func (_m *EventsDataInterface) ReadSpecificEvent(id string) (events.EventsCore, error) {
	ret := _m.Called(id)
...
func (_m *EventsDataInterface) UpdateEvent(id string, data events.EventsCore, image *multipart.FileHeader) (events.EventsCore, error) {
...
// NewEventsDataInterface creates a new instance of EventsDataInterface. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewEventsDataInterface(t interface {
	mock.TestingT
	Cleanup(func())
}) *EventsDataInterface {
	mock := &EventsDataInterface{}
	mock.Mock.Test(t)
